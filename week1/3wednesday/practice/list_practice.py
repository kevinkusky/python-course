...
print('First Color: ', colors[0].title())
...
# twoThree = list(map(titleFunc, colors[1:3])

                
# print('Color Two and Three: ', twoThree)
print(colors[1:3])
...
print ('SORTED COLORS', sorted(colors, key=str.upper))